...
- /datasets/visits_info_short.csv. [Скачать датасет;](https://code.s3.yandex.net/datasets/visits_info_short.csv)
- /datasets/orders_info_short.csv. [Скачать датасет;](https://code.s3.yandex.net/datasets/orders_info_short.csv)
- /datasets/costs_info_short.csv. [Скачать датасет.](https://code.s3.yandex.net/datasets/costs_info_short.csv)
